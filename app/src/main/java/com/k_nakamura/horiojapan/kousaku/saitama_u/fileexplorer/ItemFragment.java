...
public class ItemFragment extends Fragment implements AbsListView.OnItemClickListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (mItem != null) {
            ((TextView) getActivity().findViewById(R.id.nowDir)).setText(mItem.parentReference.path);
        } else {
            ((TextView)getActivity().findViewById(R.id.nowDir)).setText(null);
        }
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.fragment_folder_list, container, false);
        ...
        return new DefaultCallback<Item>(context) {
            ...
            public void success(final Item item) {
                ...
                if (getView() != null) {
                    ...
                    ((TextView)getActivity().findViewById(R.id.nowDir)).setText(fragmentLabel);
    ...
    private void refresh() {
        ...
        //oneDriveClient.getShare("root").buildRequest().get();
    }
